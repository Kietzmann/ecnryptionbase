...
import edu.kytsmen.java.encryption.hashsums.core.dstu7564.Utils.Pack;
...
public class DSTU7564 {
    ...
    public DSTU7564(DSTU7564 digest)
    {
        copyIn(digest);
    }

    private void copyIn(DSTU7564 digest)
    {
    ...
    public DSTU7564(int hashSizeBits)
    {
